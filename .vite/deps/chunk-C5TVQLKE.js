...
function isReactElement(node) {
  return (0, import_react2.isValidElement)(node) && !(0, import_react_is.isFragment)(node);
}
var supportNodeRef = function supportNodeRef2(node) {
  return isReactElement(node) && supportRef(node);
};
var getNodeRef = Number(import_react2.version.split(".")[0]) >= 19 ? (
  // >= React 19
  function(node) {
...
react-is/cjs/react-is.development.js:
   ...
   *)
*/
//# sourceMappingURL=chunk-C5TVQLKE.js.map

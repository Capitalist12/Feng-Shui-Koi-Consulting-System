...
const Button = ({handleCalculateCompatibility}) => {
  return (
    <StyledWrapper>
      <button className="button" onClick={() => handleCalculateCompatibility()}>
        ...
        <span className="text_button">Tính độ tương hợp</span>
      </button>
    </StyledWrapper>
  );
}
...
const StyledWrapper = styled.div`
  ...
  .button::before {
    ...
    box-shadow: inset 0 0.5px hsl(0, 0%, 100%), inset 0 -1px 2px 0 hsl(0, 0%, 0%),
      ...
      0 0 0 calc(var(--active, 0) * 0.1rem) hsl(150, 50%, 100% );

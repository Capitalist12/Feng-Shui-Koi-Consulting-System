...
public class UserMapperImpl implements UserMapper {
    ...
    public UpdateProfileResponse toUpdateProfileResponse(User user) {
        ...
        UpdateProfileResponse.UpdateProfileResponseBuilder updateProfileResponse = UpdateProfileResponse.builder();

        updateProfileResponse.userID( user.getUserID() );
        updateProfileResponse.username( user.getUsername() );
        updateProfileResponse.password( user.getPassword() );
        updateProfileResponse.dateOfBirth( user.getDateOfBirth() );
        updateProfileResponse.imageLink( user.getImageLink() );
        updateProfileResponse.roleName( user.getRoleName() );

        return updateProfileResponse.build();
    }
}

        ...
        <>
            ...
            <Row id="consultant-tank-container">
                ...
                <Col span={10} style={{ display: 'flex', justifyContent: 'center', alignItems: 'center' }}>
                    <div className="image">
                        <Image alt="tank-image" src={tankList[0].imageURL || `https://firebasestorage.googleapis.com/v0/b/fengshui-koi-consulting-system.appspot.com/o/c55b0ffe58b40d152147b58a734b25cf.jpg?alt=media&token=d021d7a7-15d0-4c8f-b1d6-3544c86532f0`} />
                    </div>
                </Col>
            </Row>
        </>

    ...
    return (
        <>
            {currentStep === 0 ?
                ...
                : currentStep === 1 ?
                    <OTPForm verifiedMail={verifiedMail} setIsLoading={setIsLoading} handleFinish={handleVerifyOTP} />
                    :
                    <Form onFinish={handleUpdatePassword} className="forget-password-form input-new-password">

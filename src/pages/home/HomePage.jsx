    ...
    <div>
      <section id="hero-section">
        <div className="main-content">
          <div className="title">
            <h1>FENG SHUI KOI CONSULTANT</h1>
            <p>
      ...
      <section id="inspec-section">
        <div ref={containerRef} className="input-yearOfBirth-container">
          ...
          <div className="input-form">
            <Form>
              <label htmlFor="yearOfBirth" style={{ color: "white" }}>
          ...
          <div className="note">
            <h2>Chú thích</h2>
            <p>
              Năm sinh là năm sinh dương lịch trên giấy tờ (chứng minh thư, bằng
              lái, khai sinh…) của bạn.
              <br />
              Hệ thống sẽ trả về các giống/loài cá Koi, phong thủy và hướng đặt
              của hồ cá theo mệnh ngũ hành dựa trên kết quả năm sinh bạn nhập
              vào.
              <br />
              Trong ngũ hành âm dương, 5 yếu tố Kim – Mộc – Thủy – Hỏa – Thổ
              luôn vận hành liên tục, vừa hỗ trợ, vừa khắc chế lẫn nhau.
              <br />
              Mối quan hệ tương sinh, tương khắc này được ứng dụng trong phong
              thủy và các lĩnh vực trong cuộc sống.
              <br />
              Mỗi người sẽ có tuổi và mệnh khác nhau. Để hiểu hơn về cung mệnh
              là gì, nhấn vào đây &nbsp;
          ...
          <div
            ...
            style={{
              ...
              transition:
                scrollProgress === 1 ? "transform 1.5s ease-out" : "none",
            }}
          ></div>
        ...
        <Row>
          ...
          <Col span={12} className="element-info">
            ...
            <div className="info-content">
              <p>
                Theo quan niệm của người phương Đông, ngũ hành tác động đến vạn
                vật trên trái đất. Ngũ hành có 5 yếu tố cơ bản là: Kim, Mộc,
                Thủy, Hỏa, Thổ. Các yếu tố này đều có sự tác động qua lại lẫn
                nhau và có những tính chất riêng.
              </p>
              <ul>
                <li>
              ...
              <p>
                Ngũ hành có 3 đặc tính cơ bản đó là lưu hành, luân chuyển, biến
                đổi không ngừng. Lưu hành có nghĩa là 5 vật chất lưu hành tự
                nhiên trong không gian và thời gian. Ví như nước khi lưu hành nó
                sẽ cuốn đi tất cả mọi thứ nó lướt qua. Luân chuyển nghĩa 5 vật
                chất luân chuyển tự nhiên. Ví dụ hành mộc là cây sẽ phát triển
                từ mầm rồi lớn dần theo thời gian. Biến đổi không ngừng có nghĩa
                là 5 vật chất sẽ biến đổi ví dụ như kim loại trong lòng đất được
                khai thác để chế tác thành các vật dụng trong cuộc sống hay mộc
                phát triển dần và sẽ thu được gỗ để làm nhà hay các vật dụng nội
                thất bằng gỗ.
              </p>

              <h3>1.3 Các quy luật của ngũ hành</h3>
              <p>
                Trong ngũ hành có hai quy luật lớn được ứng dụng nhiều là quy
                luật tương sinh và quy luật tương khắc. Hai yếu tố này không
                tách rời mà luôn có sự gắn kết với nhau, trong tương sinh luôn
                có mầm mống của tương khắc, ngược lại trong tương khắc luôn tồn
                tại tương sinh. Đây cũng chính là nguyên lý cơ bản nhất để duy
                trì sự sống của vạn vật.
              </p>
            </div>
          </Col>
        </Row>
        ...
        <Row>
          ...
          >
            ...
            <Row>
              ...
              >
                <p>
                  Xem thêm nhiều bài đăng mua bán về cá koi, vật phẩm trang trí
                  hồ cá theo phong thủy tại mục &nbsp;
                </p>
                <NavLink
          ...
          <Col span={8} className="blog" style={{ backgroundColor: "black" }}>
            <Row>
              <h2>Blog kiến thức, chia sẻ kinh nghiệm</h2>
            </Row>
